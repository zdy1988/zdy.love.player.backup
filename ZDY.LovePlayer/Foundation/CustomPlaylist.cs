...
namespace ZDY.LovePlayer.Foundation
{
    ...
    public class CustomPlaylist : Playlist<CustomPlaylistEntry>
    {
        ...
        private readonly MediaPlayerPlaylistViewModel ViewModel;

        /// <summary>
        /// Initializes a new instance of the <see cref="CustomPlaylist" /> class.
        /// </summary>
        /// <param name="viewModel">The view model.</param>
        public CustomPlaylist(MediaPlayerPlaylistViewModel viewModel)
        {
            ViewModel = viewModel;
            ...
            {
                Name = Untils.Constants.ProductName;
                Attributes["x-projecturl"] = Untils.Constants.ProductUrl;
                SaveEntries();
            }

            // Update the version
            Attributes["x-version"] = Untils.Constants.ProductVersion;
        }
