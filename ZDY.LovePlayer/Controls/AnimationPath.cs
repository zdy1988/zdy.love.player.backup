...
using ZDY.LovePlayer.Untils.Helper;
using ZDY.LovePlayer.Untils.Extension;

namespace ZDY.LovePlayer.Controls
{
    public class AnimationPath : Shape
    {
        ...
        public static readonly DependencyProperty PathLengthProperty = DependencyProperty.Register(
            "PathLength", typeof(double), typeof(AnimationPath), new FrameworkPropertyMetadata(.0, OnPropertiesChanged));
